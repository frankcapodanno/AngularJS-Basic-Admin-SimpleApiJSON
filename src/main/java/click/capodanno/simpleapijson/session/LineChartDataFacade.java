...
import click.capodanno.simpleapijson.entities.LineChartData;
 ...
 */
@Stateless
public class LineChartDataFacade extends AbstractFacade<LineChartData> {
    ...
    public LineChartDataFacade() {
        super(LineChartData.class);
    }
