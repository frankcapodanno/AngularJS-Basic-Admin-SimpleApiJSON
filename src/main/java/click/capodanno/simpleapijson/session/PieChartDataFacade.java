...
import click.capodanno.simpleapijson.entities.PieChartData;
 ...
 */
@Stateless
public class PieChartDataFacade extends AbstractFacade<PieChartData> {
    ...
    public PieChartDataFacade() {
        super(PieChartData.class);
    }
